...
<template>
  <main class="px-6 md:px-16 lg:px-32 pb-16 md:pb-32">
    ...
    <div class="projects-container grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
      <div
      ...
      >
        <RouterLink
          ...
          class="block h-full group relative aspect-square rounded-xl overflow-hidden border border-white/10 hover:border-white/30 hover:scale-[1.02] hover:shadow-2xl hover:shadow-white/10 transition-all duration-300"
        >
          <!-- Background Image -->
          <img
