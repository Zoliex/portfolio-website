...
interface Props {
  title?: { translateX?: number; translateY?: number; translateZ?: number; rotateX?: number; rotateY?: number; rotateZ?: number; };
  description?: { translateX?: number; translateY?: number; translateZ?: number; rotateX?: number; rotateY?: number; rotateZ?: number; };
  image?: { translateX?: number; translateY?: number; translateZ?: number; rotateX?: number; rotateY?: number; rotateZ?: number; };
  btnLeft?: { translateX?: number; translateY?: number; translateZ?: number; rotateX?: number; rotateY?: number; rotateZ?: number; };
  btnRight?: { translateX?: number; translateY?: number; translateZ?: number; rotateX?: number; rotateY?: number; rotateZ?: number; };
}

const props = withDefaults(defineProps<Props>(), {
  title: () => ({ translateX: 0, translateY: 0, translateZ: 40, rotateX: 0, rotateY: 0, rotateZ: 0 }),
  description: () => ({ translateX: 0, translateY: 0, translateZ: 50, rotateX: 0, rotateY: 0, rotateZ: 0 }),
  image: () => ({ translateX: 0, translateY: 0, translateZ: 60, rotateX: 0, rotateY: 0, rotateZ: 0 }),
  btnLeft: () => ({ translateX: 0, translateY: 0, translateZ: 20, rotateX: 0, rotateY: 0, rotateZ: 0 }),
  btnRight: () => ({ translateX: 0, translateY: 0, translateZ: 20, rotateX: 0, rotateY: 0, rotateZ: 0 }),
});
...
const educationnal_background = [
  ...
  },
  {
    ...
    training_name: "BUT Génie Electrique et Informatique Industrielle - 2024 - 2026",
    training_description: "Spécialité Électronique et Systèmes Embarqués. Parcours en alternance.",
  },
  {
    id: "INSA",
    label: "INSA de Rennes",
    img: "/schools/insa_of_rennes.jpeg",
    training_name: "Titre ingénieur - Spécialité Électronique - 2026 - 2029 (A venir)",
...
const experiences = [
  {
    ...
    experience_decription: "Création d’un outil de visualisation des rendements de production et amélioration continue des bancs de test. Durée : 2 ans.",
  },
  {
    ...
    experience_decription: "Organisation d’événements étudiants (soirées, intégration, tournois, ...), gestion et travail en équipe.",
  },
  {
    ...
    experience_decription: "Prise de notes pour un étudiant en situation de handicap.",
  },
];
...
const skills = [
  {
    ...
    description: "Dimensionnement de circuits analogiques/numériques, routage de cartes avec EasyEDA et Proteus.",
    image: "/skills_images/pcb_design.png",
  },
  {
    title: "Programmation Embarquée",
    description: "Développement bas niveau (C/C++, Python) pour microcontrôleurs : famille ESP32, puces WCH (CH32V003), et Raspberry Pi Pico.",
    image: "/skills_images/smart_arduino_car.jpg",
  },
  {
    title: "Développement Web & Logiciel",
    description: "Création d'applications Fullstack, Desktop et Mobile avec des technologies modernes : Vue.js, TypeScript, Tailwind CSS, Node.js.",
    image: "/skills_images/code.png",
  },
  {
    title: "Tests, Diagnostic & Réparation",
    description: "Recherche de pannes, réparation de cartes défectueuses et développement d'outils de visualisation pour des bancs de test.",
    image: "/skills_images/bench.jpg",
  },
  {
    title: "Prototypage & CAO 3D",
    description: "Modélisation de pièces et boîtiers sur Fusion 360, impression 3D via Bambu Studio.",
...
<template>
  ...
  >
    ...
    <section id="about-me" class="w-full scroll-mt-32 pt-20 md:pt-30 flex justify-center px-8 md:px-10 xl:px-32">
      <div class="w-full">
        <div class="gsap-section-fade opacity-0">
          <h1
